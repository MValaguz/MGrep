...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.b_save_pref.setIcon(icon1)
        ...
        self.gridLayout.addWidget(self.e_dboracle1, 4, 3, 1, 4)
        self.e_dboracle2 = QtWidgets.QLineEdit(self.centralwidget)
        self.e_dboracle2.setObjectName("e_dboracle2")
        self.gridLayout.addWidget(self.e_dboracle2, 5, 3, 1, 4)
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("icons/go.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_search.setIcon(icon2)
        self.b_search.setObjectName("b_search")
        self.gridLayout.addWidget(self.b_search, 7, 5, 1, 2)
        self.b_pathname = QtWidgets.QPushButton(self.centralwidget)
        self.b_pathname.setText("")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("icons/folder.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_pathname.setIcon(icon3)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("icons/add.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_add_line.setIcon(icon4)
        ...
        self.b_excludepath.setIcon(icon3)
