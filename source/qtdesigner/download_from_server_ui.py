...
class Ui_download_from_window(object):
    def setupUi(self, download_from_window):
        ...
        download_from_window.resize(444, 116)
        icon = QtGui.QIcon()
        ...
        self.gridLayout.addWidget(self.b_destination_dir, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.b_start_download, 2, 1, 1, 1)
