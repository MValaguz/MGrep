...
class Ui_MyPrefFileWindow(object):
    def setupUi(self, MyPrefFileWindow):
        MyPrefFileWindow.setObjectName("MyPrefFileWindow")
        MyPrefFileWindow.resize(800, 600)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/icons/MGrep.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        MyPrefFileWindow.setWindowIcon(icon)
        self.centralwidget = QtWidgets.QWidget(MyPrefFileWindow)
        ...
        MyPrefFileWindow.setCentralWidget(self.centralwidget)
        self.statusbar = QtWidgets.QStatusBar(MyPrefFileWindow)
        self.statusbar.setObjectName("statusbar")
        MyPrefFileWindow.setStatusBar(self.statusbar)
        ...
        self.retranslateUi(MyPrefFileWindow)
        self.o_lst1.doubleClicked['QModelIndex'].connect(MyPrefFileWindow.o_lst1_slot)
        self.b_save_pref.clicked.connect(MyPrefFileWindow.b_save_slot)
        self.b_add_line.clicked.connect(MyPrefFileWindow.b_add_line_slot)
        self.b_pathname.clicked.connect(MyPrefFileWindow.b_pathname_slot)
        self.b_excludepath.clicked.connect(MyPrefFileWindow.b_excludepath_slot)
        self.b_search.clicked.connect(MyPrefFileWindow.b_search_slot)
        QtCore.QMetaObject.connectSlotsByName(MyPrefFileWindow)
        MyPrefFileWindow.setTabOrder(self.e_stringa1, self.e_stringa2)
        MyPrefFileWindow.setTabOrder(self.e_stringa2, self.c_flsearch)
        MyPrefFileWindow.setTabOrder(self.c_flsearch, self.e_pathname)
        MyPrefFileWindow.setTabOrder(self.e_pathname, self.b_pathname)
        MyPrefFileWindow.setTabOrder(self.b_pathname, self.e_filter)
        MyPrefFileWindow.setTabOrder(self.e_filter, self.e_excludepath)
        MyPrefFileWindow.setTabOrder(self.e_excludepath, self.b_excludepath)
        MyPrefFileWindow.setTabOrder(self.b_excludepath, self.c_dbsearch)
        MyPrefFileWindow.setTabOrder(self.c_dbsearch, self.e_dboracle1)
        MyPrefFileWindow.setTabOrder(self.e_dboracle1, self.e_dboracle2)
        MyPrefFileWindow.setTabOrder(self.e_dboracle2, self.e_outputfile)
        MyPrefFileWindow.setTabOrder(self.e_outputfile, self.b_save_pref)
        MyPrefFileWindow.setTabOrder(self.b_save_pref, self.b_add_line)
        MyPrefFileWindow.setTabOrder(self.b_add_line, self.b_search)
        MyPrefFileWindow.setTabOrder(self.b_search, self.o_lst1)

    def retranslateUi(self, MyPrefFileWindow):
        _translate = QtCore.QCoreApplication.translate
        MyPrefFileWindow.setWindowTitle(_translate("MyPrefFileWindow", "Search string in sources of Oracle Forms/Reports"))
        self.l_stringa1.setText(_translate("MyPrefFileWindow", "Search string1"))
        self.l_stringa2.setText(_translate("MyPrefFileWindow", "and Search string2"))
        self.l_filter.setText(_translate("MyPrefFileWindow", "File filter"))
        self.c_dbsearch.setText(_translate("MyPrefFileWindow", "Execute search in OracleDB"))
        self.l_dboracle2.setText(_translate("MyPrefFileWindow", "Oracle connection2"))
        self.c_flsearch.setText(_translate("MyPrefFileWindow", "Execute search in folder"))
        self.l_dboracle1.setText(_translate("MyPrefFileWindow", "Oracle connection1"))
        self.b_add_line.setToolTip(_translate("MyPrefFileWindow", "<html><head/><body><p>Add the selected line to \'My favorites files</p></body></html>"))
        self.b_save_pref.setToolTip(_translate("MyPrefFileWindow", "<html><head/><body><p>Save the search data in order to be retrieved at the next start of SmiGrep</p></body></html>"))
        self.b_search.setText(_translate("MyPrefFileWindow", "Start search"))
        self.l_excludepath.setText(_translate("MyPrefFileWindow", "Exclude directories"))
        self.l_pathname.setText(_translate("MyPrefFileWindow", "Folder name"))
        self.l_outputfile.setText(_translate("MyPrefFileWindow", "Output file csv"))
...
if __name__ == "__main__":
    ...
    MyPrefFileWindow = QtWidgets.QMainWindow()
    ui = Ui_MyPrefFileWindow()
    ui.setupUi(MyPrefFileWindow)
    MyPrefFileWindow.show()
    sys.exit(app.exec_())
