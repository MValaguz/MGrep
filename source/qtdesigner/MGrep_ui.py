...
class Ui_MGrepWindow(object):
    def setupUi(self, MGrepWindow):
        ...
        self.menuWindows.addAction(self.actionTile_horizontaly)
        self.menuWindows.addAction(self.actionTile_vertically)
    ...
    def retranslateUi(self, MGrepWindow):
        ...
        self.menuWindows.setTitle(_translate("MGrepWindow", "Windows"))
