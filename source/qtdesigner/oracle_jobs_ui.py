...
class Ui_oracle_jobs_window(object):
    def setupUi(self, oracle_jobs_window):
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/icons/history.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_history.setIcon(icon2)
        self.b_history.setObjectName("b_history")
        self.gridLayout.addWidget(self.b_history, 11, 2, 1, 1)
        ...
        oracle_jobs_window.setTabOrder(self.o_lst1, self.b_history)
