...
class Ui_Program_info(object):
    def setupUi(self, Program_info):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(Program_info)
        ...
        self.buttonBox.accepted.connect(Program_info.slot_Program_info_close)
    ...
    def retranslateUi(self, Program_info):
        ...
        self.label_2.setText(_translate("Program_info", "<html><head/><body><p><span style=\" font-weight:600;\">MGrep </span></p><p>© 2016-2019</p><p>MGrep is a set of utilities created to facilitate </p><p>the programming work in Oracle Forms enviroment.</p><p>Developed by <span style=\" font-weight:600;\">Marco Valaguzza</span> (Italy) </p><p>with Python 3.6 and QT library 5</p><p><br/></p></body></html>"))
