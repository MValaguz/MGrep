...
class Ui_oracle_top_sessions_window(object):
    def setupUi(self, oracle_top_sessions_window):
        ...
        self.b_help.setText("")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/icons/help.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.gridLayout.addWidget(self.l_parameter, 4, 0, 1, 1)
        self.l_server_name = QtWidgets.QLabel(self.centralwidget)
        self.l_server_name.setObjectName("l_server_name")
        self.gridLayout.addWidget(self.l_server_name, 5, 0, 1, 1)
    ...
    def retranslateUi(self, oracle_top_sessions_window):
        ...
        self.b_help.setToolTip(_translate("oracle_top_sessions_window", "Parameter Help"))
