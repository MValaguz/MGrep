...
class import_excel_into_oracle(QtWidgets.QWidget):
    ...
    def creo_tabella(self, 
        ...
        try:    
            ...
            message_error("Problem during create Oracle table!" + chr(10) + "The table " + p_table_name + " already exists?" + chr(10) + "Remember that the excel file must be haven't formatting and filters activated!")            
            #esco
            return 'ko'
