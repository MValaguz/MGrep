...
class MyQComboBox(QtWidgets.QComboBox):
    ...
    def focusInEvent(self, e):        
        super(MyQComboBox, self).focusInEvent(e)
        print('di fatto il metodo fucusInEvent di QComboBox viene esteso!!!!!')
        print('quindi nella classe principale va usato MyQComboBox anziché QComboBox!')
...
class Ui_import_export_window(object):
    def setupUi(self, import_export_window):
        ...
        self.e_table_name = MyQComboBox(self.centralwidget)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/icons/refresh.gif"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.b_table_name.setIcon(icon7)
        self.b_table_name.setObjectName("b_table_name")
        self.gridLayout.addWidget(self.b_table_name, 8, 3, 1, 1)
        self.b_oracle_table = QtWidgets.QPushButton(self.centralwidget)
        self.b_oracle_table.setText("")
        self.b_oracle_table.setIcon(icon7)
        self.b_oracle_table.setObjectName("b_oracle_table")
        self.gridLayout.addWidget(self.b_oracle_table, 18, 3, 1, 1)
        ...
        self.b_table_to_oracle.setIcon(icon7)
        self.b_table_to_oracle.setObjectName("b_table_to_oracle")
        self.gridLayout.addWidget(self.b_table_to_oracle, 15, 3, 1, 1)
        ...
        self.b_table_excel.setIcon(icon7)
        self.b_table_excel.setObjectName("b_table_excel")
        self.gridLayout.addWidget(self.b_table_excel, 12, 3, 1, 1)
